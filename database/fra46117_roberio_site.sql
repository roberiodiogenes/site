...
--
-- Host: localhost:3306
-- Tempo de geração: 15/06/2026 às 12:56
...
--
-- Banco de dados: `fra46117_roberio_site`
--
...
--
-- Estrutura para tabela `admin_log`
--
...
INSERT INTO `admin_users` (`id`, `username`, `password`, `ultimo_login`, `created_at`) VALUES
(1, 'admin', '$2y$12$pY9b2umN38/6ej6DEJorh.V9LUuRbuyyaG1k/b/OhbGMmxt9DiyBC', '2026-06-15 12:51:03', '2026-06-11 21:46:13');

-- --------------------------------------------------------

--
-- Estrutura para tabela `analytics_eventos`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Eventos de comportamento: leitura, downloads, leads, tempo de permanência';

--
-- Despejando dados para a tabela `analytics_eventos`
--

INSERT INTO `analytics_eventos` (`id`, `session_id`, `usuario_id`, `tipo_evento`, `conteudo_slug`, `conteudo_titulo`, `params`, `tempo_permanencia`, `registrado_em`) VALUES
...
--
-- Estrutura para tabela `analytics_sessoes`
--
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Sessões anônimas e autenticadas com dados de origem de tráfego';

--
-- Despejando dados para a tabela `analytics_sessoes`
--

INSERT INTO `analytics_sessoes` (`id`, `session_id`, `usuario_id`, `utm_source`, `utm_medium`, `utm_campaign`, `utm_term`, `utm_content`, `dispositivo`, `idioma`, `referrer`, `landing_page`, `pagina_tipo`, `ip_hash`, `iniciada_em`) VALUES
...
--
-- Estrutura para tabela `auth_log`
--
...
--
-- Despejando dados para a tabela `auth_log`
--

INSERT INTO `auth_log` (`id`, `ip`, `action`, `created_at`) VALUES
...
INSERT INTO `avaliacoes` (`id`, `usuario_id`, `livro_slug`, `estrelas`, `avaliado_em`, `atualizado_em`) VALUES
...
--
-- Estrutura para tabela `bio_clicks`
--
...
--
-- Estrutura para tabela `bio_config`
--
...
--
-- Despejando dados para a tabela `bio_config`
--

INSERT INTO `bio_config` (`chave`, `valor`) VALUES
('cor_acento', '#B8860B'),
('cor_fundo', '#0D0A07'),
...
--
-- Estrutura para tabela `bio_eventos`
--
...
--
-- Despejando dados para a tabela `bio_eventos`
--

INSERT INTO `bio_eventos` (`id`, `sessao_id`, `evento`, `genero`, `estrategia`, `rede_social`, `usuario_id`, `ip`, `referrer`, `utm_source`, `criado_em`) VALUES
...
--
-- Estrutura para tabela `bio_links`
--
...
--
-- Despejando dados para a tabela `bio_links`
--

INSERT INTO `bio_links` (`id`, `titulo`, `subtitulo`, `url`, `icone`, `tipo`, `ativo`, `ordem`, `criado_em`) VALUES
...
--
-- Estrutura stand-in para view `bi_canal_retencao`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `bi_canal_retencao` (
`canal` varchar(100)
,`meio` varchar(100)
,`total_sessoes` bigint(21)
,`leitores_ativos` bigint(21)
,`media_segundos_pagina` decimal(11,0)
,`media_percentual_leitura` double(17,0)
);

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `bi_conteudo_engajamento`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `bi_conteudo_engajamento` (
`conteudo_slug` varchar(200)
,`titulo` varchar(300)
,`total_visualizacoes` bigint(21)
,`media_segundos` decimal(11,0)
,`max_percentual_lido` double
,`downloads_amostra` bigint(21)
,`leads_gerados` bigint(21)
);
...
--
-- Estrutura para tabela `campanhas_envios`
--
...
INSERT INTO `carrinhos` (`id`, `usuario_id`, `itens`, `em_checkout`, `lembrete_env`, `lembrete_em`, `checkout_em`, `atualizado_em`) VALUES
...
--
-- Estrutura para tabela `clusters`
--
...
--
-- Despejando dados para a tabela `clusters`
--

INSERT INTO `clusters` (`id`, `slug`, `titulo`, `descricao`, `imagem_url`, `cor`, `pilar_slug`, `ativo`, `criado_em`) VALUES
...
--
-- Estrutura para tabela `comentarios_flags_log`
--
...
INSERT INTO `compras` (`id`, `usuario_id`, `livro_slug`, `preco_pago`, `status`, `gateway`, `ref_externa`, `comprado_em`, `atualizado_em`) VALUES
...
INSERT INTO `contato` (`id`, `nome`, `email`, `assunto`, `mensagem`, `ip`, `lida`, `criado_em`) VALUES
...
--
-- Estrutura para tabela `downloads_log`
--
...
--
-- Despejando dados para a tabela `downloads_log`
--

INSERT INTO `downloads_log` (`id`, `usuario_id`, `livro_slug`, `formato`, `arquivo`, `ip`, `baixado_em`) VALUES
...
--
-- Estrutura para tabela `email_cliques`
--
...
--
-- Despejando dados para a tabela `email_cliques`
--

INSERT INTO `email_cliques` (`id`, `usuario_id`, `acao`, `ip`, `user_agent`, `clicado_em`) VALUES
...
--
-- Estrutura para tabela `embaixadores`
--
...
--
-- Despejando dados para a tabela `embaixadores`
--

INSERT INTO `embaixadores` (`id`, `genero`, `sessao_id`, `ip`, `criado_em`) VALUES
(1, 'drama', 'ck9eg7o3n8mqemm84j', '170.82.213.33', '2026-06-15 03:01:06');
...
--
-- Estrutura para tabela `enquetes_opcoes`
--
...
INSERT INTO `favoritos` (`id`, `usuario_id`, `livro_slug`, `adicionado_em`) VALUES
(1, 1, 'a-setima-lei', '2026-06-12 16:19:08');

-- --------------------------------------------------------

--
-- Estrutura para tabela `leitor_anotacoes`
--
...
--
-- Despejando dados para a tabela `leitor_anotacoes`
--

INSERT INTO `leitor_anotacoes` (`id`, `usuario_id`, `livro_slug`, `capitulo`, `texto`, `cor`, `criado_em`, `atualizado_em`) VALUES
(1, 10, 'a-setima-lei', 0, 'Ler com cuidado', '#7EC8E0', '2026-06-13 13:55:50', '2026-06-13 13:55:50');

-- --------------------------------------------------------

--
-- Estrutura para tabela `leitor_conquistas`
--
...
--
-- Despejando dados para a tabela `leitor_conquistas`
--

INSERT INTO `leitor_conquistas` (`id`, `usuario_id`, `livro_slug`, `tipo`, `conquistado_em`, `email_enviado`) VALUES
...
--
-- Estrutura para tabela `leitor_erros`
--
...
--
-- Despejando dados para a tabela `leitor_erros`
--

INSERT INTO `leitor_erros` (`id`, `usuario_id`, `livro_slug`, `cfi`, `trecho`, `descricao`, `resolvido`, `criado_em`) VALUES
...
--
-- Estrutura para tabela `leitor_lembretes_enviados`
--
...
--
-- Estrutura para tabela `leitor_marcacoes`
--
...
--
-- Despejando dados para a tabela `leitor_marcacoes`
--

INSERT INTO `leitor_marcacoes` (`id`, `usuario_id`, `livro_slug`, `capitulo`, `cfi_range`, `trecho`, `cor`, `nota`, `criado_em`) VALUES
(1, 10, 'a-setima-lei', 1, 'epubcfi(/6/18!/4/70,/1:0,/1:26)', 'Finanças, poder e vergonha', 'amarelo', NULL, '2026-06-13 13:55:19');

-- --------------------------------------------------------

--
-- Estrutura para tabela `leitor_notas_autor`
--
...
--
-- Estrutura para tabela `leitor_preferencias`
--
...
--
-- Despejando dados para a tabela `leitor_preferencias`
--

INSERT INTO `leitor_preferencias` (`usuario_id`, `fonte`, `tamanho_fonte`, `fundo_leitura`, `largura_coluna`, `altura_linha`, `atualizado_em`) VALUES
...
--
-- Estrutura para tabela `leitor_progresso`
--
...
--
-- Despejando dados para a tabela `leitor_progresso`
--

INSERT INTO `leitor_progresso` (`id`, `usuario_id`, `livro_slug`, `cfi`, `capitulo_atual`, `posicao_scroll`, `percentual`, `total_paginas`, `iniciado_em`, `ultima_leitura`, `concluido`, `concluido_em`, `tempo_total_min`) VALUES
...
--
-- Estrutura para tabela `leitura_conquistas`
--
...
INSERT INTO `livros` (`id`, `slug`, `tipo`, `titulo`, `subtitulo`, `genero`, `sinopse`, `capa_img`, `arquivo_pdf`, `arquivo_epub`, `pasta_conteudo`, `total_capitulos`, `preco`, `preco_promocao`, `promo_ate`, `gratuito_ate`, `link_amazon`, `data_pub`, `badges`, `ativo`, `destaque`, `gratuito`, `novo`, `ordem`, `criado_em`) VALUES
...
--
-- Estrutura para tabela `magic_links`
--
...
INSERT INTO `newsletter` (`id`, `email`, `nome`, `whatsapp`, `ip`, `origem`, `status`, `token_verificacao`, `token_expira`, `pref_bastidores`, `pref_reflexao`, `pref_escritor`, `pref_livros`, `descad_em`, `created_at`) VALUES
(1, 'roberiodiogenes.frdc@gmail.com', NULL, NULL, '170.82.213.33', 'popup_saida', 'ativo', NULL, NULL, 1, 1, 1, 1, NULL, '2026-06-12 10:35:45');

-- --------------------------------------------------------

--
-- Estrutura para tabela `newsletter_disparos`
--
...
--
-- Estrutura para tabela `newsletter_log`
--
...
--
-- Estrutura para tabela `password_reset`
--
...
--
-- Despejando dados para a tabela `password_reset`
--

INSERT INTO `password_reset` (`id`, `usuario_id`, `token`, `expira_em`, `criado_em`, `usado_em`) VALUES
(4, 1, '18bdea51208f59a79b29b56d2ae444da426bee7b8976e344f36d989d5bd737f2', '2026-06-12 17:34:20', '2026-06-12 15:34:20', NULL);

-- --------------------------------------------------------

--
-- Estrutura para tabela `pdf_cliques`
--
...
--
-- Despejando dados para a tabela `pdf_cliques`
--

INSERT INTO `pdf_cliques` (`id`, `usuario_id`, `pdf_nome`, `ip`, `user_agent`, `criado_em`) VALUES
...
INSERT INTO `planos` (`id`, `slug`, `nome`, `descricao`, `preco`, `duracao_dias`, `ativo`, `criado_em`) VALUES
...
INSERT INTO `posts` (`id`, `slug`, `titulo`, `subtitulo`, `categoria`, `tags`, `resumo`, `corpo`, `imagem_url`, `audio_url`, `livro_slug`, `destaque`, `status`, `publicado_em`, `exclusivo`, `percentual_livre`, `enquete_id`, `cluster_id`, `newsletter_enviado`, `tipo_post`, `estatico`, `tempo_leitura`, `html_externo`, `criado_em`, `atualizado_em`) VALUES
...
--
-- Estrutura para tabela `posts_lidos`
--
...
--
-- Estrutura para tabela `pre_lancamentos`
--
...
--
-- Estrutura para tabela `pre_lancamento_leads`
--
...
--
-- Estrutura para tabela `temas_sazonais`
--
...
--
-- Despejando dados para a tabela `temas_sazonais`
--

INSERT INTO `temas_sazonais` (`id`, `nome`, `slug`, `ativo`, `prioridade`, `dia_inicio`, `mes_inicio`, `dia_fim`, `mes_fim`, `cor_ouro`, `cor_ferrugem`, `criado_em`, `atualizado_em`) VALUES
(1, 'Ano Novo', 'ano-novo', 1, 1, 28, 12, 3, 1, '#A8B8D0', '#1A2C5A', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(2, 'Carnaval', 'carnaval', 1, 2, 8, 2, 5, 3, '#9B59B6', '#16A085', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(3, 'Dia Internacional da Mulher', 'dia-mulher', 1, 3, 6, 3, 8, 3, '#8E24AA', '#C62828', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(4, 'Dia Internacional do Livro Infantil', 'dia-livro-infantil', 1, 4, 30, 3, 2, 4, '#D81B60', '#7B1FA2', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(5, 'Dia do Livro', 'dia-livro', 1, 5, 18, 4, 23, 4, '#9A6B1A', '#6B3A28', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(6, 'Dia das Mães', 'dia-maes', 1, 6, 5, 5, 11, 5, '#C2185B', '#7B1FA2', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(7, 'Dia dos Namorados', 'dia-namorados', 1, 7, 10, 6, 12, 6, '#B71C1C', '#880E4F', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(8, 'Dia da Literatura Brasileira', 'dia-literatura-brasileira', 1, 8, 23, 7, 25, 7, '#2E7D32', '#E65100', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(9, 'Dia dos Pais', 'dia-pais', 1, 9, 7, 8, 11, 8, '#1565C0', '#0D47A1', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(10, '7 de Setembro', 'sete-setembro', 1, 10, 5, 9, 8, 9, '#F9A825', '#1B5E20', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(11, 'Dia Nacional do Escritor', 'dia-escritor', 1, 11, 17, 9, 19, 9, '#8D6E63', '#4E342E', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(12, 'Nossa Senhora Aparecida', 'nossa-senhora-aparecida', 1, 12, 10, 10, 12, 10, '#1565C0', '#9C7B00', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(13, 'Dia das Crianças', 'dia-criancas', 0, 13, 10, 10, 12, 10, '#FF6F00', '#00838F', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(14, 'Halloween', 'halloween', 1, 14, 27, 10, 31, 10, '#E65100', '#4A148C', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(15, 'Finados', 'finados', 1, 15, 31, 10, 2, 11, '#7B1FA2', '#E65100', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(16, '15 de Novembro', 'quinze-novembro', 1, 16, 13, 11, 15, 11, '#2E7D32', '#F9A825', '2026-06-12 00:50:35', '2026-06-12 00:50:35'),
(17, 'Natal', 'natal', 1, 17, 1, 12, 25, 12, '#C62828', '#2E7D32', '2026-06-12 00:50:35', '2026-06-12 00:50:35');
...
INSERT INTO `usuarios` (`id`, `nome`, `email`, `senha`, `tipo`, `sexo`, `data_nascimento`, `cidade`, `estado`, `pais`, `whatsapp`, `google_id`, `foto_url`, `ip_cadastro`, `verificado`, `token_confirmacao`, `token_expira_em`, `email_confirmado_em`, `ativo`, `ultimo_login`, `created_at`, `updated_at`) VALUES
...
--
-- Estrutura para tabela `usuario_interesses`
--
...
INSERT INTO `visitas` (`id`, `total`) VALUES
(1, 38);

-- --------------------------------------------------------

--
-- Estrutura para tabela `visitas_log`
--
...
--
-- Despejando dados para a tabela `visitas_log`
--

INSERT INTO `visitas_log` (`id`, `visitor_hash`, `visit_date`, `visited_at`) VALUES
...
--
-- Estrutura stand-in para view `vw_acesso_leitura`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `vw_acesso_leitura` (
`usuario_id` int(11) unsigned
,`livro_slug` varchar(100)
...
,`assinaturas_ativas` bigint(21)
,`total_compras` bigint(21)
,`receita_mes_compras` decimal(30,2)
,`receita_mes_assinaturas` decimal(30,2)
,`leads_newsletter` bigint(21)
,`leads_pre_lancamento` bigint(21)
);

-- --------------------------------------------------------

--
-- Estrutura stand-in para view `vw_ultimas_leituras`
-- (Veja abaixo para a visão atual)
--
CREATE TABLE `vw_ultimas_leituras` (
`usuario_id` int(10) unsigned
,`livro_slug` varchar(100)
,`titulo` varchar(200)
,`capa_img` varchar(200)
,`capitulo_atual` smallint(5) unsigned
...
--
-- Índices de tabela `analytics_eventos`
--
ALTER TABLE `analytics_eventos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_session` (`session_id`),
  ADD KEY `idx_tipo` (`tipo_evento`),
  ADD KEY `idx_slug` (`conteudo_slug`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_registrado` (`registrado_em`);

--
-- Índices de tabela `analytics_sessoes`
--
ALTER TABLE `analytics_sessoes`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `assinaturas`
  ...
  ADD KEY `fk_assin_plano` (`plano_id`);

--
-- Índices de tabela `auth_log`
--
...
ALTER TABLE `avaliacoes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_aval` (`usuario_id`,`livro_slug`);

--
-- Índices de tabela `bio_clicks`
--
ALTER TABLE `bio_clicks`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_bc_link_id` (`link_id`),
  ADD KEY `idx_bc_link_slug` (`link_slug`),
  ADD KEY `idx_bc_clicado` (`clicado_em`),
  ADD KEY `idx_bc_origem` (`origem`(100));

--
-- Índices de tabela `bio_config`
--
ALTER TABLE `bio_config`
  ADD PRIMARY KEY (`chave`);

--
-- Índices de tabela `bio_eventos`
--
ALTER TABLE `bio_eventos`
  ADD PRIMARY KEY (`id`),
...
--
-- Índices de tabela `campanhas_envios`
--
ALTER TABLE `campanhas_envios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_campanha_id` (`campanha_id`),
...
ALTER TABLE `carrinhos`
  ...
  ADD KEY `idx_carr_lembrete` (`lembrete_env`,`atualizado_em`);

--
-- Índices de tabela `clusters`
--
...
ALTER TABLE `comentarios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_livro_aprovado` (`livro_slug`,`aprovado`),
  ADD KEY `idx_referencia_tipo` (`referencia`,`tipo`,`aprovado`),
  ADD KEY `idx_usuario_id` (`usuario_id`),
  ADD KEY `idx_parent_id` (`parent_id`),
  ADD KEY `idx_flagged` (`flagged`);

--
-- Índices de tabela `comentarios_flags_log`
--
ALTER TABLE `comentarios_flags_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_cfl_comentario` (`comentario_id`),
  ADD KEY `idx_cfl_acao` (`acao_tomada`),
  ADD KEY `idx_cfl_data` (`criado_em`);
...
ALTER TABLE `comentario_curtidas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_curtida` (`comentario_id`,`usuario_id`),
  ADD KEY `idx_cc_usuario` (`usuario_id`);
...
ALTER TABLE `compras`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_compra` (`usuario_id`,`livro_slug`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_livro_slug` (`livro_slug`),
  ADD KEY `idx_status` (`status`),
  ADD KEY `idx_comprado_em` (`comprado_em`);
...
ALTER TABLE `curtidas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_curtida_usuario` (`post_slug`,`usuario_id`),
  ADD KEY `idx_post_slug` (`post_slug`);
...
--
-- Índices de tabela `downloads_log`
--
ALTER TABLE `downloads_log`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_livro` (`livro_slug`);

--
-- Índices de tabela `email_cliques`
--
ALTER TABLE `email_cliques`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_acao` (`acao`),
  ADD KEY `idx_data` (`clicado_em`);

--
-- Índices de tabela `embaixadores`
--
ALTER TABLE `embaixadores`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_sessao` (`sessao_id`);
...
--
-- Índices de tabela `enquetes_opcoes`
--
...
ALTER TABLE `enquetes_respostas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_er_enquete` (`enquete_id`),
  ADD KEY `idx_er_opcao` (`opcao_id`);
...
ALTER TABLE `favoritos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_fav` (`usuario_id`,`livro_slug`);

--
-- Índices de tabela `leitor_anotacoes`
--
ALTER TABLE `leitor_anotacoes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_usuario_livro` (`usuario_id`,`livro_slug`);

--
-- Índices de tabela `leitor_conquistas`
--
ALTER TABLE `leitor_conquistas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_conquista` (`usuario_id`,`livro_slug`,`tipo`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_livro` (`livro_slug`);

--
-- Índices de tabela `leitor_erros`
--
ALTER TABLE `leitor_erros`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_livro_resolvido` (`livro_slug`,`resolvido`),
  ADD KEY `idx_usuario` (`usuario_id`);

--
-- Índices de tabela `leitor_lembretes_enviados`
--
ALTER TABLE `leitor_lembretes_enviados`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_lembrete` (`usuario_id`,`livro_slug`),
  ADD KEY `idx_enviado_em` (`enviado_em`);

--
-- Índices de tabela `leitor_marcacoes`
--
...
--
-- Índices de tabela `leitor_notas_autor`
--
ALTER TABLE `leitor_notas_autor`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_livro` (`livro_slug`);

--
-- Índices de tabela `leitor_preferencias`
--
ALTER TABLE `leitor_preferencias`
  ADD PRIMARY KEY (`usuario_id`);

--
-- Índices de tabela `leitor_progresso`
--
ALTER TABLE `leitor_progresso`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_progresso` (`usuario_id`,`livro_slug`),
  ADD KEY `idx_ultima_leitura` (`ultima_leitura`),
  ADD KEY `idx_percentual` (`percentual`);

--
-- Índices de tabela `leitura_conquistas`
--
ALTER TABLE `leitura_conquistas`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_conquista` (`usuario_id`,`livro_slug`,`marco`),
  ADD KEY `idx_usuario` (`usuario_id`);
...
ALTER TABLE `livros_favoritos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_usuario_livro` (`usuario_id`,`livro_id`);

--
-- Índices de tabela `magic_links`
--
ALTER TABLE `magic_links`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_ml_token` (`token`),
  ADD KEY `idx_ml_usuario` (`usuario_id`);
...
--
-- Índices de tabela `newsletter_disparos`
--
ALTER TABLE `newsletter_disparos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_nd_post` (`post_slug`);

--
-- Índices de tabela `newsletter_log`
--
...
--
-- Índices de tabela `password_reset`
--
...
--
-- Índices de tabela `pdf_cliques`
--
ALTER TABLE `pdf_cliques`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_pdf` (`pdf_nome`),
  ADD KEY `idx_data` (`criado_em`);
...
ALTER TABLE `posts`
  ...
  ADD KEY `idx_publicado_em` (`publicado_em`),
  ADD KEY `idx_destaque` (`destaque`),
  ADD KEY `idx_cluster_id` (`cluster_id`),
  ADD KEY `idx_exclusivo` (`exclusivo`),
  ADD KEY `idx_tipo_post` (`tipo_post`);

--
-- Índices de tabela `posts_lidos`
--
ALTER TABLE `posts_lidos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_lido` (`usuario_id`,`post_slug`),
  ADD KEY `idx_usuario` (`usuario_id`),
  ADD KEY `idx_post_slug` (`post_slug`);
...
ALTER TABLE `presentes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_token` (`token_acesso`),
  ADD KEY `idx_comprador` (`comprador_id`),
  ADD KEY `idx_email_presenteado` (`email_presenteado`),
  ADD KEY `idx_status` (`status`);

--
-- Índices de tabela `pre_lancamentos`
--
...
--
-- Índices de tabela `pre_lancamento_leads`
--
ALTER TABLE `pre_lancamento_leads`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_lead` (`lancamento_id`,`email`),
  ADD KEY `idx_ll_lancamento` (`lancamento_id`),
  ADD KEY `idx_ll_email` (`email`),
  ADD KEY `idx_ll_brinde` (`brinde_enviado`);

--
-- Índices de tabela `temas_sazonais`
--
ALTER TABLE `temas_sazonais`
  ADD PRIMARY KEY (`id`),
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `idx_token_confirmacao` (`token_confirmacao`);

--
-- Índices de tabela `usuario_interesses`
--
ALTER TABLE `usuario_interesses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_usuario_cat` (`usuario_id`,`categoria`),
  ADD KEY `idx_cat` (`categoria`),
  ADD KEY `idx_ultima` (`ultima_vista`);
...
--
-- Índices de tabela `visitas_log`
--
ALTER TABLE `visitas_log`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uq_visitor_dia` (`visitor_hash`,`visit_date`),
...
--
-- AUTO_INCREMENT de tabela `admin_log`
--
ALTER TABLE `admin_log`
...
--
-- AUTO_INCREMENT de tabela `analytics_eventos`
--
ALTER TABLE `analytics_eventos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=568;

--
-- AUTO_INCREMENT de tabela `analytics_sessoes`
--
ALTER TABLE `analytics_sessoes`
...
--
-- AUTO_INCREMENT de tabela `auth_log`
--
ALTER TABLE `auth_log`
...
--
-- AUTO_INCREMENT de tabela `bio_clicks`
--
ALTER TABLE `bio_clicks`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `bio_eventos`
--
ALTER TABLE `bio_eventos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=115;

--
-- AUTO_INCREMENT de tabela `bio_links`
--
ALTER TABLE `bio_links`
...
--
-- AUTO_INCREMENT de tabela `campanhas_envios`
--
ALTER TABLE `campanhas_envios`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `clusters`
--
ALTER TABLE `clusters`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de tabela `comentarios_flags_log`
--
ALTER TABLE `comentarios_flags_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `downloads_log`
--
ALTER TABLE `downloads_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;

--
-- AUTO_INCREMENT de tabela `email_cliques`
--
ALTER TABLE `email_cliques`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `embaixadores`
--
ALTER TABLE `embaixadores`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT de tabela `leitor_anotacoes`
--
ALTER TABLE `leitor_anotacoes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `leitor_conquistas`
--
ALTER TABLE `leitor_conquistas`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=674;

--
-- AUTO_INCREMENT de tabela `leitor_erros`
--
ALTER TABLE `leitor_erros`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de tabela `leitor_lembretes_enviados`
--
ALTER TABLE `leitor_lembretes_enviados`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `leitor_marcacoes`
--
ALTER TABLE `leitor_marcacoes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de tabela `leitor_notas_autor`
--
ALTER TABLE `leitor_notas_autor`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `leitor_progresso`
--
ALTER TABLE `leitor_progresso`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1303;

--
-- AUTO_INCREMENT de tabela `leitura_conquistas`
--
ALTER TABLE `leitura_conquistas`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `magic_links`
--
ALTER TABLE `magic_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `newsletter_disparos`
--
ALTER TABLE `newsletter_disparos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `newsletter_log`
--
ALTER TABLE `newsletter_log`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `pdf_cliques`
--
ALTER TABLE `pdf_cliques`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de tabela `posts_lidos`
--
ALTER TABLE `posts_lidos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `pre_lancamentos`
--
ALTER TABLE `pre_lancamentos`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `pre_lancamento_leads`
--
ALTER TABLE `pre_lancamento_leads`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `temas_sazonais`
--
ALTER TABLE `temas_sazonais`
...
--
-- AUTO_INCREMENT de tabela `usuario_interesses`
--
ALTER TABLE `usuario_interesses`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de tabela `visitas_log`
--
ALTER TABLE `visitas_log`
...
--
-- Estrutura para view `bi_canal_retencao`
--
...
--
-- Estrutura para view `vw_ultimas_leituras`
--
...
--
-- Restrições para tabelas `admin_log`
--
ALTER TABLE `admin_log`
  ADD CONSTRAINT `fk_al_admin` FOREIGN KEY (`admin_id`) REFERENCES `admin_users` (`id`) ON DELETE SET NULL;

--
-- Restrições para tabelas `assinaturas`
--
ALTER TABLE `assinaturas`
  ADD CONSTRAINT `fk_assin_plano` FOREIGN KEY (`plano_id`) REFERENCES `planos` (`id`),
  ADD CONSTRAINT `fk_assin_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
...
--
-- Restrições para tabelas `campanhas_envios`
--
ALTER TABLE `campanhas_envios`
  ADD CONSTRAINT `fk_cenv_campanha` FOREIGN KEY (`campanha_id`) REFERENCES `campanhas` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `carrinhos`
--
ALTER TABLE `carrinhos`
  ADD CONSTRAINT `fk_carr_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `comentarios`
--
ALTER TABLE `comentarios`
  ADD CONSTRAINT `fk_com_parent` FOREIGN KEY (`parent_id`) REFERENCES `comentarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `comentarios_flags_log`
--
ALTER TABLE `comentarios_flags_log`
  ADD CONSTRAINT `fk_cfl_comentario` FOREIGN KEY (`comentario_id`) REFERENCES `comentarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `comentario_curtidas`
--
ALTER TABLE `comentario_curtidas`
  ADD CONSTRAINT `fk_cc_comentario` FOREIGN KEY (`comentario_id`) REFERENCES `comentarios` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_cc_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `downloads`
  ADD CONSTRAINT `fk_dl2_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `downloads_log`
--
ALTER TABLE `downloads_log`
  ADD CONSTRAINT `fk_dl_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `enquetes_opcoes`
--
ALTER TABLE `enquetes_opcoes`
  ADD CONSTRAINT `fk_eopc_enquete` FOREIGN KEY (`enquete_id`) REFERENCES `enquetes` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `enquetes_respostas`
--
ALTER TABLE `enquetes_respostas`
  ADD CONSTRAINT `fk_er_enquete` FOREIGN KEY (`enquete_id`) REFERENCES `enquetes` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_er_opcao` FOREIGN KEY (`opcao_id`) REFERENCES `enquetes_opcoes` (`id`) ON DELETE CASCADE;
...
--
-- Restrições para tabelas `leitor_anotacoes`
--
ALTER TABLE `leitor_anotacoes`
  ADD CONSTRAINT `fk_anot_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `leitor_erros`
--
ALTER TABLE `leitor_erros`
  ADD CONSTRAINT `fk_erro_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `leitor_lembretes_enviados`
--
ALTER TABLE `leitor_lembretes_enviados`
  ADD CONSTRAINT `fk_lem_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `leitor_marcacoes`
--
ALTER TABLE `leitor_marcacoes`
  ADD CONSTRAINT `fk_marc_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `leitor_preferencias`
--
ALTER TABLE `leitor_preferencias`
  ADD CONSTRAINT `fk_pref_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `leitor_progresso`
--
ALTER TABLE `leitor_progresso`
  ADD CONSTRAINT `fk_prog_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `livros_favoritos`
--
ALTER TABLE `livros_favoritos`
  ADD CONSTRAINT `fk_lf_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `magic_links`
--
ALTER TABLE `magic_links`
  ADD CONSTRAINT `fk_ml_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `password_reset`
--
ALTER TABLE `password_reset`
  ADD CONSTRAINT `fk_pr_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `posts_lidos`
--
ALTER TABLE `posts_lidos`
  ADD CONSTRAINT `fk_pl_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `presentes`
--
ALTER TABLE `presentes`
  ADD CONSTRAINT `fk_pres_comprador` FOREIGN KEY (`comprador_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `pre_lancamento_leads`
--
ALTER TABLE `pre_lancamento_leads`
  ADD CONSTRAINT `fk_lead_lancamento` FOREIGN KEY (`lancamento_id`) REFERENCES `pre_lancamentos` (`id`) ON DELETE CASCADE;

--
-- Restrições para tabelas `usuario_interesses`
--
ALTER TABLE `usuario_interesses`
  ADD CONSTRAINT `fk_int_usuario` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE;

DELIMITER $$
--
-- Eventos
--
CREATE DEFINER=`root`@`localhost` EVENT `evt_limpar_tokens` ON SCHEDULE EVERY 1 DAY STARTS '2026-06-11 21:50:35' ON COMPLETION NOT PRESERVE ENABLE DO CALL `limpar_tokens_expirados`()$$

CREATE DEFINER=`root`@`localhost` EVENT `evt_limpar_logs` ON SCHEDULE EVERY 1 WEEK STARTS '2026-06-11 21:50:35' ON COMPLETION NOT PRESERVE ENABLE DO CALL `limpar_logs_antigos`()$$
